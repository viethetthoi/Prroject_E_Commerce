...
@push('styles')
    <link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('public/assets/css/demo2.css') }}">
@endpush
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            <div>
                                                <img src="{{ asset('public/assets/images/fashion/product/front') }}/{{ $product->image }}"
                                            ...
                                            @if ($product->images)
                                                ...
                                                @foreach ($images as $image)
                                                    <div>
                                                        <img src="{{ asset('public/assets/images/fashion/product/front') }}/{{ $image }}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="details-image-1 ratio_asos">
                                            <div>
                                                <img src="{{ asset('public/assets/images/fashion/product/front') }}/{{ $product->image }}" id="zoom_01"
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    <div class="product-count">
                                        <ul>
                                            <li>
                                                <img src="{{ asset('public/assets/images/gif/fire.gif') }}"
                                                    class="img-fluid blur-up lazyload" alt="image">
                                                <span class="p-counter">37</span>
                                                <span class="lang">orders in last 24 hours</span>
                                            </li>
                                            <li>
                                                <img src="{{ asset('public/assets/images/gif/person.gif') }}"
                                            ...
                                            <ul class="image-section">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset('public/assets/images/fashion/product/front/5.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset('public/assets/images/fashion/product/front/6.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img src="{{ asset('public/assets/images/fashion/product/front/7.jpg') }}"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="product-buttons">
                                        <a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('addtocart-{{ $product->id }}').submit();" class="btn btn-solid hover-solid btn-animation" id="cartEffect">
                                            <i class="fa fa-shopping-cart"></i>
                                            <span>Add To Cart</span>
                                        </a>

                                        <form id="addtocart-{{ $product->id }}" method="post" action="{{ route('cart.store') }}" style="display:none;">
                                            @csrf
                                    ...
                                    <ul class="product-count shipping-order">
                                        <li>
                                            <img src="{{ asset('public/assets/images/gif/truck.png') }}" class="img-fluid blur-up lazyload"
                                                alt="image">
                                        ...
                                        <div class="customer-review-box">
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('public/assets/images/inner-page/review-image/1.jpg') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('public/assets/images/inner-page/review-image/2.jpg') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('public/assets/images/inner-page/review-image/3.jpg') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="{{ asset('public/assets/images/inner-page/review-image/4.jpg') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                ...
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{route('shop.product.details', ['slug'=>$rproduct->slug])}}">
                                            <img src="
                                            {{ asset('public/assets/images/fashion/product/front') }}/{{ $rproduct->image }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="{{route('shop.product.details', ['slug'=>$rproduct->slug])}}">
                                            <img src="{{ asset('public/assets/images/fashion/product/back') }}/{{ $rproduct->image }}""
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
