...
<meta name="mobile-web-app-capable" content="yes">
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/vendors/ion.rangeSlider.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/css/vendors/slick/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/css/vendors/slick/slick-theme.css')}}">
    <link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('public/assets/css/demo4.css')}}">
    <style>
        .h-logo {public/
...
<body class="theme-color4 light ltr">
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="{{ asset('public/assets/images/logo.png') }}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                ...
                <div class="row gy-3">
                    <div class="col-md-6">
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('public/assets/images/payment-icon/1.jpg') }}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('public/assets/images/payment-icon/2.jpg') }}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('public/assets/images/payment-icon/3.jpg') }}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('public/assets/images/payment-icon/4.jpg') }}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                        </ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <img src="{{ asset('public/assets/images/newletter-icon.png') }}" class="img-fluid blur-up lazyload" alt="">
                        ...
                        <div>
                            ...
                            <div class="modal-product">
                                <div class="modal-contain-img">
                                    <img src="{{ asset('public/assets/images/fashion/instagram/4.jpg') }}" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                                                ...
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{ asset('public/assets/images/fashion/product/front/1.jpg') }}"
                                        ...
                                        <div>
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{ asset('public/assets/images/fashion/product/front/2.jpg') }}"
                                                                class="bg-img blur-up lazyload" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{ asset('public/assets/images/fashion/product/front/3.jpg') }}"
                                                                class="bg-img blur-up lazyload" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="product/details.html">
                                                            <img src="{{ asset('public/assets/images/fashion/product/front/4.jpg') }}"
                                                                class="bg-img blur-up lazyload" alt="">
                                                        </a>
                                                    </div>
                                                </div>
    ...
    <script src="{{ asset('public/assets/js/price-filter.js')}}"></script>
    <script src="{{ asset('public/assets/js/ion.rangeSlider.min.js')}}"></script>
    <script src="{{ asset('public/assets/js/filter.js')}}"></script>
    <script src="{{ asset('public/assets/js/newsletter.js')}}"></script>
    <script src="{{ asset('public/assets/js/cart_modal_resize.js')}}"></script>
