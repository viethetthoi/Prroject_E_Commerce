        ...
        <div class="container">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('shop.product.details', ['slug'=> $item->model->slug]) }}">
                                                <img src="{{ asset('public/assets/images/fashion/product/front') }}/{{ $item->model->image }}"
                                                    class=" blur-up lazyload" alt="{{ $item->model->name }}">
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="javascript:void(0)" class="icon disable">
                                                    <i class="fas fa-shopping-cart"></i>
                                                </a>
                                            @endif
            ...
            <div class="row">
                <div class="col-md-12 text-end">
                    <a href="javascript:void(0)" onclick="clearWishlist()">Clear All Wishlist</a>
                </div>
            </div>
            @else
                <div class="row">
